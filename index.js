...
form.addEventListener("submit", e => {
    ...
    if (valido) {
        ...
        .then(json => {
            datosLocalStorage(datos);
            mostrarModal("¡Datos enviados con éxito al servidor!");
        })
        .catch(err => {
            mostrarModal("Hubo un error al enviar los datos: " + err.message);
        });
    } else {
        mostrarModal("Hay errores en el formulario. Corríjalos antes de enviar.");
    }
});
